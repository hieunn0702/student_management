                    ...
                    <tbody>
                        @forelse ($departments as $department)
                            <tr>
                                ...
                                <td>
                                    <a href="" wire:click="showEditModal({{ $department->id }})" class="btn btn-success">Edit</a>
                                    <a href="" wire:click="deleteDepartment({{ $department->id }})" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                            @empty
                            <tr>
